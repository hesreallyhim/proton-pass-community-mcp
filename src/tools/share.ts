...
export const passShareListInputSchema = z.object({
  onlyItems: z.boolean().optional(),
  onlyVaults: z.boolean().optional(),
  output: z.enum(["json", "human"]).default("json"),
});

export type PassShareListInput = z.infer<typeof passShareListInputSchema>;

export async function passShareListHandler(passCli: PassCliRunner, input: PassShareListInput) {
