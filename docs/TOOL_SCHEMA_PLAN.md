...
| `create_note_item`                | `pass-cli item create note`                  | Planned                    | required: `confirm`; optional: selector + note fields; template mode supported by CLI (see inferred schema doc)                                                               | Created item   |
| `create_credit_card_item`         | `pass-cli item create credit-card`           | Planned                    | required: `confirm`; optional: selector + card fields; template mode supported by CLI (see inferred schema doc)                                                               | Created item   |
| `create_wifi_item`                | `pass-cli item create wifi`                  | Planned                    | required: `confirm`; optional: selector + wifi fields; template mode supported by CLI (see inferred schema doc)                                                               | Created item   |
| `create_custom_item`              | `pass-cli item create custom`                | Planned                    | required: `confirm`; optional: selector + custom fields; template mode supported by CLI (see inferred schema doc)                                                             | Created item   |
| `create_identity_item`            | `pass-cli item create identity`              | Planned                    | required: `confirm`; optional: selector + identity fields; template mode supported by CLI (see inferred schema doc)                                                           | Created item   |
